...
#library(gridExtra)
#library(scales)
#source("/home/byrne/myRpackages/bicrnaseq/R/bic_analyze_counts.R")
#source("/home/byrne/myRpackages/bicrnaseq/R/bic_plots.R")
#source("/home/byrne/myRpackages/bicrnaseq/R/bic_util.R")
...
if(is.null(cds)){
  for(c in comps){
      ...
      cat("\nZERO RESULTS\n")
      header = paste(c("GeneID","GeneSymbol", "P.adj",
                      paste("log2[",condB,"/",condA,"]",sep=""),
                      paste("Mean_at_cond_",condA, sep=""),
                      paste("Mean_at_cond_",condB, sep="")),collapse="\t")
