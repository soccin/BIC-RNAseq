...
if(!-e "$progdir/$pre\_$uID\_RSEQC_MP_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams $PYTHON/mismatch_profile.py -i $bam -o "$intdir/$file_pre" -l 50`; ## NEED TO CHANGE THIS TO ACTUAL READ LENGTH
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.mismatch_profile.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_RDP_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams $PYTHON/read_duplication.py -i $bam -o "$intdir/$file_pre"`;
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.DupRate_plot.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_RGC_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.GC_plot.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_NVC_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.NVC_plot.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_RQ_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.qual.*.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_IP_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.insertion_profile.R*.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_DP_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.deletion_profile.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_CP_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.clipping_profile.R*.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_JA_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.splice_*.pdf $outdir`;
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_JS_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.junctionSaturation_plot.pdf $outdir`;
}
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_IE_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams $PYTHON/infer_experiment.py -i $bam ">$intdir/$file_pre" -r $bed`;
...
if(!-e "$progdir/$pre\_$uID\_RSEQC_ID_$sample.done" || $forceall){
    ...
    my $standardParams = Schedule::queuing(%stdParams);
    `$standardParams->{submit} $standardParams->{job_name} $standardParams->{job_hold} $standardParams->{cpu} $standardParams->{mem} $standardParams->{cluster_out} $additionalParams mv $intdir/$file_pre.inner_distance_plot.pdf $outdir`;
}
